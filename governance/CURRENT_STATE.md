...
Cinema guard: PVR Priya = strongest current enthusiast pick for a large modern Delhi IMAX; never claim `best cinema in world`, true 1.43 dual-laser or 70mm IMAX. Delite is an OPEN historic 1954 Delhi movie-palace alternative if a strong Hindi-film/crowd experience fits. Exact film/showtime/subtitle/screen is `LIVE_RECHECK_LATER` for the final Delhi day-card stage.
...
## OPTIONAL WORLD SURVIVAL — CURRENT MARK-ONLY FRONTIER
...
## AFTER MARK CHOOSES
Automatically:
1. create/update the exact Mark decision artifact with WHY;
