...
Built: 2026-09-14, as part of the successor-boot slimming (PR #23)

This is a map of everything outside the active cockpit (`CURRENT_TRUTH.md`, `CURRENT_FRONTIER.md`, `HOW_TO_WORK_WITH_MARK.md`, `GUARDRAILS.md`, `MARK_TO_INDIA_SUCCESSOR_HUMAN_HANDOFF.md`). Nothing listed here was deleted or judged worthless — it's classified so a fresh successor knows what to leave alone versus what to open when a specific need arises.
...
| `INDIA_BEHAVIORAL_EXECUTION_CONTRACT.md`, `INDIA_ACTIVE_MEMORY_COMPILATION_GATE.md`, `MAP_COORDINATE_VERIFICATION_RULE.md`, `INDIA_HUMAN_CENTERED_COMPLEX_TRIP_PLANNING_STANDARD.md`, `FINAL_COMFORT_SWEEP_RULE_2026-08-23.md`, `EXACT_DELEGATION_BINDING_RULE.md`, `MARK_LOCATION_NAMING_CONTEXT_PROTOCOL.md` | ON-DEMAND EVIDENCE | Full reasoning/examples behind the condensed rules in `GUARDRAILS.md` and `HOW_TO_WORK_WITH_MARK.md`. Read only if the condensed version is unclear or contested. |
...
| `MARK_TRAVEL_PREFERENCES_CURRENT.md` | ON-DEMAND EVIDENCE | The full "why Mark feels this way" layer. Genuinely still useful, deliberately kept out of the mandatory boot to keep it short — read when the compact `HOW_TO_WORK_WITH_MARK.md` isn't enough. |
