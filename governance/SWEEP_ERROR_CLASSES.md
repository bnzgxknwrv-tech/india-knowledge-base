...
| FK-011 | Categorie-dekking verward met Mark-relevantie | Een kandidaat wordt behouden/genummerd omdat een religie/traditie/land "nog niet vertegenwoordigd" was, zonder AOAY-link, Top-X-link, of aantoonbare eigen religieuze zwaarte | Mongolian Temple (069) werd aanvankelijk te makkelijk behouden omdat "Mongoolse vertegenwoordiging" ontbrak in de kandidatenlijst | Poort E.1 (Prioriteitslagen: AOAY-override → Top-X-toets → hoge drempel voor overige religieuze zwaargewichten; coverage-lens opent alleen discovery, is nooit zelfstandig bewijs) | Handmatig (INDIA-controle bij nummering tegen E.1-beslisvolgorde); `active_in_report`-veld in `preflight_validator.py` kan een expliciete override-reden verplicht maken in v2 | 2026-08-08 |
