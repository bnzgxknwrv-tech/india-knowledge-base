...
*Openstaande verbetering, nog niet doorgevoerd om geen extra re-pin te forceren tijdens een lopende boot (zie STAP 5): het FOUT 25-bericht moet ook expliciet vragen "wat denk je zelf dat je nog mist of vergeet?" als aparte zelfaudit-vraag, niet alleen "dump alles". Voer dit door op het eerstvolgende natuurlijke moment dat er geen boot in uitvoering is.*
