...
- **21 Dec:** dedicated Hotel Evelyn → Crank's Ridge / Govinda world → Hotel Evelyn immersion day, without Grot Vivekananda. This protects more ridge quiet and reduces day load. **Repaired 2026-09-21** (semantic-loss check on the v3 PDF): the Mark-facing day had thinned to a generic "vrij rondlopen Crank's Ridge" block with no distinct places/persons named. Full content restored from `research/KASAR_DEVI_CRANKS_RIDGE_SUNYATA_GOVINDA_RAM_DASS_RECOVERY_2026-09-14.md` and `runs/active/WORK_KUMAON_CRANKS_RIDGE_GOVINDA_FINAL_BASE_CORRIDOR_SOLVE_2026-09-14.md` — see `runs/active/KUMAON_CURRENT_BEST_DAYPLAN_19_29_DEC_2026-09-16.md` for the restored chronology. Grot Vivekananda stays excluded from 21 Dec per the binding "23 ok" lock.
