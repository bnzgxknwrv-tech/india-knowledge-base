...
## WOENSDAG 23 DECEMBER — Kakrighat (twee lagen) + Grot Vivekananda → Hotel adiMOUNT (Dwarahat)

**Start:** Hotel Evelyn. **Slaapplek:** Hotel adiMOUNT, Dwarahat [LOCKED, 3 nachten — ~840m/~5 min lopen van YSS Dwarahat].
...
- **16:00–16:15** — Aankomst **Hotel adiMOUNT, Dwarahat**. Inchecken.
- **±19:25–19:30** — indien energie het toelaat: **te voet** (~5 min) naar het optionele ±19:30 kennismakingsbezoek YSS Dwarahat — **DIRECT-CONFIRM**, alleen doen als het de dag niet overbelast; anders vervalt dit zonder gevolgen. Nu een korte wandeling in plaats van een terugrit.
...
**Start/einde:** Hotel adiMOUNT, Dwarahat.

- **07:00** — Vertrek per vooraf geregelde lokale taxi (YSS-contact Puran Negi of via het hotel) naar Kukuchina/praktische trailhead (~20–25 km vanaf Dwarahat, ~45 min–1 u bergweg).
- **07:45–08:45** — Beklimming naar **Mahavatar Babaji's Cave [A+]** (~1 u).
...
- **15:00–16:30** — Optioneel, rustig, geen verplichting (wijkt voor grotkwaliteit als de ochtend uitliep):
  - **Maa Dunagiri Vaishnavi Temple / "Bell Temple" [A]** — een tempel bereikbaar via een lange klim/gangpad met honderden opgehangen bellen (het herkenningsbeeld dat de bijnaam verklaart).
  - **Babaji Smriti Bhavan [A]** — een meditatiehal/schrijn vlak onder Mahavatar Babaji's Cave, onderdeel van dezelfde wereld als de 1861 Babaji–Lahiri Mahasaya-inwijding — geen los, generiek gedenkteken.

`LIVE_RECHECK`: exacte duur met lokale chauffeur/gids vooraf bevestigen — schatting ~6,25 u totaal, binnen YSS's eigen officiële bandbreedte van 6–8 u vanaf de Dwarahat-ashram (adiMOUNT ligt vlak bij die ashram, dus deze officiële bandbreedte geldt nu direct, geen afgeleide/kortere schatting meer nodig).

---

## VRIJDAG 25 DECEMBER — YSS Dwarahat kerstdag

**Start/einde:** Hotel adiMOUNT, Dwarahat (~5 min lopen naar YSS — geen auto nodig deze dag).
...
## ZATERDAG 26 DECEMBER — Hotel adiMOUNT (Dwarahat) → Haidakhan Vishwa Mahadham

**Start:** Hotel adiMOUNT, Dwarahat. **Slaapplek:** Haidakhan Vishwa Mahadham-omgeving [LOCKED, 3 nachten].
...
## ZONDAG 27 DECEMBER — Haidakhan, beschermde rustdag 1/2
...
## MAANDAG 28 DECEMBER — Haidakhan, beschermde rustdag 2/2
