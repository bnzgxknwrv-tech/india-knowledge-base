...
- current true status;
- distance/time from actual base or transparent Aerocity/IGI proxy;
- nearest retained A+/A and natural retained B neighbor where relevant;
- walking/short-hop relation inside a bundle;
- `JE BENT ER TOCH` net extra burden;
