# MARK / RECOVERY DECISION — NEEM KAROLI BABA: VRINDAVAN + RED HOUSE

Date: 2026-08-29
Status: **CURRENT / SUCCESSOR-CRITICAL**

Purpose: prevent future INDIA successors from losing two Neem Karoli Baba route-relevant places or misreading their status.

## 1. NEEM KAROLI BABA ASHRAM + MAHASAMADHI MANDIR — VRINDAVAN

Recognition-rich identity:
**Neeb/Neem Karoli Baba Ashram + Mahasamadhi Mandir — active ashram containing Neem Karoli Baba's samadhi shrine in Krishna's pilgrimage city (Vrindavan, Uttar Pradesh).**
...
- a real Neem Karoli Baba ashram in Vrindavan;
- first temple inaugurated in 1967;
- the **Mahasamadhi Mandir is inside the ashram**;
- the ashram is the site of the annual Mahasamadhi Bhandara;
- current Google Maps public listing identifies the active `Neeb Karori Baba Ashram (Samadhi Temple)` on Baba Neem Karori Marg / Atalla Chungi Road.
...
A geotagged photograph taken **at the actual Mahasamadhi Mandir** gives `27.567514, 77.692331`, independently matching the earlier registry point `27.5674, 77.69215` to within a few tens of metres and not the conflicting `27.5767, 77.6865` point.

For decision-scale geography of this small ashram property:
`ENTITY_LOCATION = VERIFIED`
working coordinate: `27.567514, 77.692331`
The precise gate/entrance does not need separate closure merely to establish that this small property is in the correct place; exact approach can be live-routed later.
...
## 2. RED HOUSE / 4 CHURCH LANE — PRAYAGRAJ
...
Evidence supports all of the following:
- Neem Karoli Baba repeatedly used the house as his Allahabad winter residence from 1958 through 1973;
- after his mahasamadhi, the room/takhat became a **puja shrine**;
- visitors/devotees have gone there specifically for **darshan**;
- a first-person pilgrimage account describes being admitted to the house, entering the shrine room, and offering garland, flowers and incense to Maharaj-ji; it also describes another devotee as a daily visitor;
...
- `HISTORIC_IDENTITY = VERIFIED`
- `DEVOTIONAL_SHRINE_ROOM = VERIFIED`
- `PILGRIM/DARSHAN VISIT PRECEDENT = VERIFIED`
- `FORMAL_PUBLIC_TEMPLE/ASHRAM = NO`
- `GUARANTEED WALK-IN HOURS = NOT VERIFIED`
- `LIVE ACCESS CONFIRMATION = REQUIRED`

Do not tell Mark that it is a normal public mandir. It is a historic private residence with a functioning/maintained devotional shrine tradition and documented pilgrim darshan, but access is informal and cannot be assumed.

### Mark route rule — 2026-08-29
Mark explicitly wants to visit **if and only if**:
1. the final trip already comes through / stays in Prayagraj for other reasons; AND
...
Therefore:
- no manual map pin yet;
- no exact distance/minute claim yet;
- before any Prayagraj day geometry, independently verify the actual building coordinate/property identity at decision-relevant scale.
